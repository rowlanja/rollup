...
func (*MsgSubmitOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_fed2c5b1dcfea9ab, []int{2}
}
...
func (m *MsgSubmitOrder) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
func (m *MsgSubmitOrder) GetToken() string {
	if m != nil {
		return m.Token
	}
	return ""
...
func (*MsgSubmitOrderResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fed2c5b1dcfea9ab, []int{3}
}
...
func init() {
	...
	proto.RegisterType((*MsgSubmitOrder)(nil), "dex.dex.MsgSubmitOrder")
	proto.RegisterType((*MsgSubmitOrderResponse)(nil), "dex.dex.MsgSubmitOrderResponse")
}
...
var fileDescriptor_fed2c5b1dcfea9ab = []byte{
	...
	,
}
...
func (c *msgClient) SubmitOrder(ctx context.Context, in *MsgSubmitOrder, opts ...grpc.CallOption) (*MsgSubmitOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dex.dex.Msg/SubmitOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dex.dex.Msg/SubmitOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
