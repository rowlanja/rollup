...
const (
	...
	Msg_SubmitOrder_FullMethodName  = "/dex.dex.Msg/SubmitOrder"
)
...
func (c *msgClient) SubmitOrder(ctx context.Context, in *MsgSubmitOrder, opts ...grpc.CallOption) (*MsgSubmitOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SubmitOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) SubmitOrder(context.Context, *MsgSubmitOrder) (*MsgSubmitOrderResponse, error) {
...
func _Msg_SubmitOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SubmitOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
